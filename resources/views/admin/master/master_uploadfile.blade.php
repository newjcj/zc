...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            ...
            <h3 style="color:white;margin-bottom:4px;"> 后台管理</h3>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        ...
                        <span class="username username-hide-on-mobile"> 用户：{{\Illuminate\Support\Facades\Session::get('user')->username}}你好 </span>
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                ...
                <li class="nav-item start {{  Request::is("admin/goods/*") ? 'active open' : '' }}">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item start  {{  Request::is("admin/goods/index") ? 'active open' : '' }}">
                            <a href="/admin/goods/index" class="nav-link ">
                                <i class=""></i>
                                <span class="title"> 礼包列表 </span>
                                <span class="selected"></span>
                            </a>
                        </li>
                        <li class="nav-item start {{  Request::is("admin/goods/add") ? 'active open' : '' }} ">
                            <a href="/admin/goods/add" class="nav-link ">
                                <i class=""></i>
                                <span class="title">礼包商品</span>
                ...
                <li class="nav-item  start {{  Request::is("admin/order/*") ? 'active open' : '' }}">
                    <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item start {{  Request::is("admin/order/index") ? 'active open' : '' }} ">
                ...
                <li class="nav-item start {{  Request::is("admin/member/*") ? 'active open' : '' }}">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="icon-home"></i>
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item start  {{  Request::is("admin/member/index") ? 'active open' : '' }}">
                            <a href="/admin/member/index" class="nav-link ">
                                <i class=""></i>
                ...
                <li class="nav-item start {{  Request::is("admin/user/*") ? 'active open' : '' }}">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item start  {{  Request::is("admin/user/manager") ? 'active open' : '' }}">
