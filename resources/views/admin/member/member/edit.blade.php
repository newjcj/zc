...
@section('content')
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <div class="item">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5">
                                                        <dl class="clearfix">
                                                            <div><input value="{{ $member->name ?$member->name:'' }}" type="text" class="form-control input-xlarge" placeholder="" name="name" datatype="/^[a-zA-Z\u4e00-\u9fa5]+$/"></div>
                                        ...
                                        <div class="item">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <dl class="clearfix">
                                                        <div><input value="{{ $member->phone ?$member->phone:'' }}" type="text" class="form-control input-xlarge" placeholder="" name="phone" datatype="/^1(3|4|5|7|8)\d{9}$/"></div>
                                                        <p class="help-block"> </p>
                                                    </dl>
                                                </div>
                                            </div>
                                        <div class="item">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <dl class="clearfix">
                                                        <div><input value="{{ $member->email ?$member->email:'' }}" type="text" class="form-control input-xlarge" placeholder="" name="email" datatype="/^[a-z\d]+(\.[a-z\d]+)*@([\da-z](-[\da-z])?)+(\.{1,2}[a-z]+)+$/"></div>
                                                        <p class="help-block"> </p>
                                                    </dl>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5">
                                                        <dl class="clearfix">
                                                            <div><input value="{{ $member->password ?$member->password:'' }}" type="text" class="form-control input-xlarge" placeholder="" name="password" datatype="/^[a-z0-9_-]{6,18}$/"></div>
                                                            <p class="help-block"> </p>
                                                        </dl>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $("#upform").Validform({
            tiptype:2,
            callback:function(){
                Ajax('JSON').post('/admin/member/member/update',{
                    id:id,
                    ...
                    if(msg.status !== 1){
                        ...
                        layer.open({
                            ...
                            ,content: msg.message,
                            yes:function(){
                                window.location.href='/admin/member/member/index';
                            }
                        });
                    }
                });
