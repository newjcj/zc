...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" id="oneform" action="javascript:;" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" datatype="/\w{3,6}$/" type="text" autocomplete="off" placeholder="用户名" name="username" /> </div>
        <div style="height:20px;margin-top:-10px"></div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">密码</label>
            <input class="form-control form-control-solid placeholder-no-fix"  datatype="/\w{3,6}$/" errormsg="3到6位字母或数字" type="password" autocomplete="off" placeholder="密码" name="password" /> </div>
        <div style="height:20px;margin-top:-10px"></div>
        <p></p>
        <div class="form-actions" style="margin:0 auto;text-align:center;">
            ...
            {{--<span></span>--}}
            {{--</label>--}}
            {{--<a href="javascript:;" id="forget-password" class="forget-password">Forgot 密码?</a>--}}
        </div>
        ...
        <div class="create-account">
            <p>
                <a href="javascript:;" id="register-btn" class="uppercase">rexmall</a>
            </p>
        </div>
    </form>
    <!-- END LOGIN FORM -->
    ...
    <form class="forget-form" action="index.html" method="post">
        <h3 class="font-green">Forget 密码 ?</h3>
    ...
    <form class="register-form" action="index.html" method="post">
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">用户名</label>
            <input class="form-control placeholder-no-fix" datatype="s1-16" type="text" autocomplete="off" placeholder="用户名" name="username" /> </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">密码</label>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Re-type Your 密码</label>
            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your 密码" name="rpassword" /> </div>
