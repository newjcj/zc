...
@section('content')
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group">
                                                    ...
                                                    <input value="{{ $topimage->name ?:'' }}" type="text" name="name" class="form-control" datatype="/^[\s\S]{1,55}$/"> </div>
                                        ...
                                        <div class="item">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5" >
                                                    <div class="formControls col-5" style="float:left">
                                                        <img id="preview_id1" src="{{ $topimage->image?:'/admin/images/icon-add.png' }}" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id1').click()" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <dl class="clearfix">
                                                        <div> <input class="form-control form-control-inline input-medium date-picker" size="16" type="text" value="{{ $topimage->start ?$topimage->start:'' }}" name="start" id="start"  /></div>
                                                        <p class="help-block"> </p>
                                                    </dl>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <dl class="clearfix">
                                                        <div><input value="{{ $topimage->end ?$topimage->end:'' }}" type="text" class="form-control form-control-inline input-medium date-picker" placeholder="" name="end" ></div>
                                                        <p class="help-block"> </p>
                                                    </dl>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <dl class="clearfix">
                                                        <div><input value="{{ $topimage->url ?$topimage->url:'' }}" type="text" class="form-control input-xlarge" placeholder="" name="url" ></div>
                                                        <p class="help-block"> </p>
                                                    </dl>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $("#upform").Validform({
            tiptype:2,
            callback:function(){
                Ajax('JSON').post('/admin/topimage/topimage/update',{
                    id:id,
