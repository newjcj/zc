    ...
    <div class="vip-club border_top_bottom vip-account">
        ...
        <div class="vip-club border_top_bottom">
            <div class="vip-club-title border_bottom">
                收货人名：<input id="name" name="name" type="text" style=" border: 0px;" >
            </div>
            <div class="vip-club-title border_bottom">
                手机号码：<input id="phone" name="phone" type="text" style=" border: 0px;">
            </div>
            <div class="vip-club-title border_bottom">
                所在地区：<font size="-1"><span id="city" name="city" style="color:#d7d7d7;padding-left:5px;"><font style=" opacity: 0.5">请选择地址</font></span></font>
            </div>
            <div class="vip-club-title border_bottom" id="address">
                详细地址：<input id="address" name="address" type="text" placeholder="街道 楼牌号等" style=" border: 0px;">
            </div>
            <div class="vip-club-title border_bottom">默认地址 <div style=" float: right; margin-top: 8px;"><input type="checkbox" style=" height: 20px;" value="1" id="chk" name="chk"></div>
            </div>
            <div class="vip-club-title border_bottom">
                <p align="center"><input id="save" type="button" class="sub" value="保存并使用" style=" border:solid 0px #84c1ff; border-radius:5px;background:#f5655c;;color:#fff;width:80px; height: 35px;"></p>
            </div>
        </div>
