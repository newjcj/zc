...
@section('content')
    ...
    <div class="warp warptwo clearfloat">
        <div class="shopcar clearfloat">
            @if(count($carts))
                    ...
                    <div class="list clearfloat fl" data-id="{{$cart['goods']->id}}">
                        ...
                        <a href="javascript:void(0)">
                            ...
                            <div class="right clearfloat fl">
                                ...
                                <p class="jifen over">{{ $cart['goods']->price/100 }} 元</p>
                                <div class="bottom clearfloat">
                                    ...
                                    <i data-id="{{$cart['id']}}" class="iconfont icon-lajixiang fr"></i>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                @else
                <div class="i_car">
                    <img src="/wap/images/组22@3x_94.png" alt="">
                    <input type="button" value="去逛逛" onclick="window.location.href='/wap/home/index'">
                </div>
            @endif
        </div>
    </div>
    ...
    @section('script')
        ...
        <script>
            ...
            //删除购物车
            var _delcart=function(id){
                $.ajax({
                        url: '/wap/goods/delcart',
                        data: {
                            id:id,
                            _token: "{{csrf_token()}}"
                        },
