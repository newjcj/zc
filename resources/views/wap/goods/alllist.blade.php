...
@section('content')
	...
	<div class="vip-club border_top_bottom vip-account">
		<div class="vip-club-title border_bottom">
			...
			<span style="width:23%;display:inline-block;text-align:center;" id="span4" >价格<div  style=" width: 25px; height: 25px; float: right; margin-top: -3px; margin-right: 10px; border: #0c0c0c 0px solid;"><img  onclick="up();"  width="20" height="20" src="/wap/images/up.png" id="up"> <img style=" display: none" id="up1"  width="10" height="5" src="/wap/images/up1.png"> </div><div style=" width: 25px; height: 20px; float: right; border: #0c0c0c 0px solid; margin-top: -30px; margin-right: 10px;"  ><img onclick="down()"  id="down" width="20" height="20" src="/wap/images/down.png"><img id="down1" style=" display: none;" width="10" height="5" src="/wap/images/down1.png"></div></span>		</div>
		{{--全部订单--}}
		<div id="div1">
