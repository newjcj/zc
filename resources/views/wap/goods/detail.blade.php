...
@section('head')
    <script>
        ...
        (function() {
            ...
            hm.src = "https://hm.baidu.com/hm.js?c713f3ff27b5824a8d1a1c41407f8f35";
...
@section('content')
    ...
    <div class="warp warptwo clearfloat">
        <div class="detail clearfloat">
            ...
            <div class="banner swiper-container">
                <div class="swiper-wrapper">
                    ...
                    @foreach(explode(',',($goods->goodsimage)[0]->image) as $image)
                        @if(preg_match('/[\s\S]+\.[jsg|jpeg|png|gif]/',$image,$re))
            ...
            <div class="clearfloat infobox mcontent" style="">
                {!!$goods->content!!}
            </div>
            <div class="middle clearfloat box-s">
                <a href="/wap/goods/eval?goodid={{$goods->id}}">
    ...
    <div class="footerone clearfloat" style="bottom:0em;">
        <div class="left clearfloat fl">
            <ul>
                ...
                <li id="nb_icon_wrap" class="kf" style="display: flex;justify-content: center; align-items: center;padding-top: 0;">
                    <div>
                        <a href="#">
    ...
    <script type="text/javascript">
        ...
        $('.mcontent').css({'width':document.body.offsetWidth}).find('img').css({'width':document.body.offsetWidth});
