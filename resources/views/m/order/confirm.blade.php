...
@section('content')
        ...
        <div class="confirm clearfloat">
            ...
            @else
                ...
                <div class="gmshu clearfloat box-s fl" style="text-align:left;">
                    <a href="/wap/user/addaddress"><p class="fr" style="margin-right:2rem;">您还没有设置收货地址，点击添加</p></a>
                </div>
                </div>
            @endif
    ...
    <div class="settlement clearfloat">
        ...
        <a href="javascript:_isgreater()" class="fl db">
            提交订单
        </a>
    </div>
    <!--settlement end-->
            ...
            function _isgreater(){
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status !== 1){
                            layer.msg('用户等级小于礼包等级',{time:1000},function(){
