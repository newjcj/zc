...
@section('content')
	...
	<div class="vip-club border_top_bottom vip-account">
		<div class="vip-club-title border_bottom">
			...
			<span style="width:23%;display:inline-block;text-align:center;" id="span4" >价格<div  style=" width: 25px; height: 25px; float: right; margin-top: -3px; margin-right: 20px; border: #0c0c0c 0px solid;"><img onclick="up();"  width="20" height="20" src="/wap/images/up.png"></div><div style=" width: 25px; height: 20px; float: right; border: #0c0c0c 0px solid; margin-top: -30px; margin-right: 20px;"  ><img onclick="down()" width="20" height="20" src="/wap/images/down.png"></div></span>
		</div>
		{{--全部订单--}}
		<div id="div1">
...
@section('script')
	<script>
		...
		function up() {
            ...
            location.href="/wap/goods/list?up=1&name="+$("#good").val()+"&id="+$("#flid").val();
        }

        function down() {
            location.href="/wap/goods/list?down=1&name="+$("#good").val()+"&id="+$("#flid").val();
        }
