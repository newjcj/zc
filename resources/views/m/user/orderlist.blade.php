...
@section('content')
    ...
    <div class="vip-club border_top_bottom vip-account">
        <div class="vip-club-title border_bottom">
            <span style="width:30%;display:inline-block;text-align:center;color:red;" id="span1" onclick="move(1);">全部订单</span>
            <span style="width:30%;display:inline-block;text-align:center;" id="span2" onclick="move(2);">待付款</span>
            <span style="width:30%;display:inline-block;text-align:center;" id="span3" onclick="move(3);" >待收货</span>
        </div>
        ...
        <div class="vip-club border_top_bottom" >
            ...
            <ul>
                ...
                <li style=" float: left; margin-left: 10px; margin-top: 20px; "><font color="#a52a2a">{{ $item->goodss[0]->name}}</font></li>
                ...
                <li  style="line-height:45px;text-align:right;margin-right:20px;">
                    @if($item->status==0)
                        ...
                        <input type="button" class="sub" value="确认付款" style="line-height:30px;border:solid 1px #84c1ff;background:#1980e0;color:#fff;width:80px;" onclick="location.href='/wap/order/confirm?orders={{$item->id}}';">
                       @else
                        <input type="button" class="sub" value="投诉" style="line-height:30px;border:solid 1px #ccc;background:#fff;color:#bbb;width:80px;">
                        <input type="button" class="sub" value="查看详情"  onclick="show({{$item->id}})"  style="line-height:30px;border:solid 1px #ccc;background:#fff;color:#464646;width:80px;">
